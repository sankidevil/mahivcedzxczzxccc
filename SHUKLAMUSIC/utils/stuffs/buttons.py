...
class BUTTONS(object):
    ...
    [InlineKeyboardButton("🏷️ᴛᴀɢ-ᴀʟʟ🏷️", callback_data="mplus HELP_TagAll"),
    ...
    InlineKeyboardButton("🕸️ᴀᴄᴛɪᴏɴ🕸️", callback_data="mplus HELP_Action"),InlineKeyboardButton("🔍sᴇᴀʀᴄʜ🔎", callback_data="mplus HELP_Search")],    
